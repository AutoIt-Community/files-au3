        ...
        Case $g_hTreeView
            Switch $iCode
                Case $TVN_BEGINDRAGA, $TVN_BEGINDRAGW
                    ...
                    $sTreeDragItem = _GUICtrlTreeView_GetText($g_hTreeView, $hDragItem)
                    $bDragTreeList = True
                    $sDragSrc = "Tree"
                    ; TO DO: need to get full path of treeview drag item $sTreeDragItem
                ...
                If $aTreeList[4] = $idTreeView Then
                    Select
                        Case $sDragSrc = "Tree" ; drag and drop from treeview to treeview
                            ...
                            Local $sTreeDropItem = _GUICtrlTreeView_GetText($g_hTreeView, $iTreeItem)
                ...
                ElseIf $aTreeList[4] = $idListview Then
                    Select
                        Case $sDragSrc = "Tree" ; drag and drop from treeview to listview
                            Local $sListDropItem = _GUICtrlListView_GetItemText($idListview, _GUICtrlListView_GetHotItem($idListview), 0)
                        ...
                        Case $sDragSrc = "List" ; drag and drop from listview to listview
                            ...
                            Local $sListDropItem = _GUICtrlListView_GetItemText($idListview, $iListDrop, 0)
...
Func _ListGetSelections()
    ...
    For $i = 1 To $aListDragItems[0]
        $aListDragItems[$i] = GUICtrlRead($idInputPath) & _GUICtrlListView_GetItemText($idListview, $aListDragItems[$i], 0)
