...
; Modified ......: WildByDesign - Use of WS_ES_COMPOSITED. pixelsearch - Use of WS_VISIBLE
; ====================================================================================================================
...
;                  3 = Separator subclassing failed
; Author ........: Kip
; Modified ......: Melba23, WildByDesign (composited extended style),
; Remarks .......:
; Example........: Yes
;=====================================================================================================================
Func _GUIFrame_Create($hWnd, $iSepOrient = 0, $iSepPos = 0, $iSepSize = 5, $iX = 0, $iY = 0, $iOrg_Width = 0, $iOrg_Height = 0, $iStyle = 0, $iExStyle = 0)
    ...
    Local $hParent = GUICreate("FrameParent", $iWidth, $iHeight, $iX, $iY, BitOR($iFrame_Style, $iStyle), BitOR($iFrame_Ext_Style, $iExStyle), $hWnd)
    ...
    If $iSepOrient = 0 Then
        ...
        $hSeparator = GUICreate("SeparatorFrame", $iSeparatorSize, $iHeight, $iSeperator_Pos, 0, $iFrame_Style, $iFrame_Ext_Style, $hParent) ;$WS_CHILD
        $idSeparator = GUICtrlCreateLabel("", 0, 0, $iSeparatorSize - 5, $iHeight)
        GUICtrlSetCursor(-1, 13)
        GUISetState(@SW_SHOW, $hSeparator)
        ; Create the sizable frames
        $hFirstFrame = GUICreate("", $iSeperator_Pos, $iHeight, 0, 0, $iFrame_Style, $iFrame_Ext_Style, $hParent) ;$WS_CHILD
        GUISetState(@SW_SHOW, $hFirstFrame)
        $hSecondFrame = GUICreate("ListViewWnd", $iWidth - ($iSeperator_Pos + $iSeparatorSize), $iHeight, $iSeperator_Pos + $iSeparatorSize, 0, $iFrame_Style, $iFrame_Ext_Style, $hParent) ;$WS_CHILD
    ...
    Else
        ...
        EndIf
        $hSeparator = GUICreate("SeparatorFrame", $iWidth, $iSeparatorSize, 0, $iSeperator_Pos, $iFrame_Style, $iFrame_Ext_Style, $hParent)
        $idSeparator = GUICtrlCreateLabel("", 0, 0, $iSeparatorSize, $iHeight)
        GUICtrlSetCursor(-1, 11)
        GUISetState(@SW_SHOW, $hSeparator)
        $hFirstFrame = GUICreate("", $iWidth, $iSeperator_Pos, 0, 0, $iFrame_Style, $iFrame_Ext_Style, $hParent)
        GUISetState(@SW_SHOW, $hFirstFrame)
        $hSecondFrame = GUICreate("ListViewWnd", $iWidth, $iHeight - ($iSeperator_Pos + $iSeparatorSize), 0, $iSeperator_Pos + $iSeparatorSize, $iFrame_Style, $iFrame_Ext_Style, $hParent)
        GUISetState(@SW_SHOW, $hSecondFrame)
